...
public class LoansApiResource {
    ...
    public String retrieveAll(@Context final UriInfo uriInfo,
            ...
            @QueryParam("secured") @Parameter(description = "Filter loans by collateralization status. true = only secured loans, false = only unsecured loans") final Boolean secured) {
